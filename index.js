...
function togglePanel() {
    ...
    if (!panel) {
        ...
        header.onmousedown=(e)=>{pdrag=true;px=e.clientX-panel.offsetLeft;py=e.clientY-panel.offsetTop;panel.style.transition='none';};
        document.addEventListener('mousemove',(e)=>{if(!pdrag)return;panel.style.left=(e.clientX-px)+'px';panel.style.top=(e.clientY-py)+'px';panel.style.right='auto';});
        document.addEventListener('mouseup',()=>{pdrag=false;panel.style.transition='';});
