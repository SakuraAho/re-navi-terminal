...
export class NaviView {
    ...
    goBack() { this.currentView = 'options'; this.render(); }
    ...
    async generate(difficulty) {
        ...
        try {
            ...
            const basePrompt = pm.getPromptForFeature('navi', feature);
            ...
            const systemPrompt = basePrompt
                ...
                .replace(/\{\{ACTION_HINT\}\}/g, buildHint('action', '动作指示', '姿态和动作'))
                .replace(/\{\{ITEMS_HINT\}\}/g, buildHint('items', '辅助物品', '辅助物品'))
                .replace(/\{\{ASSIST_HINT\}\}/g, buildHint('assist', '协助人员', '协助人员和互动方式'));
